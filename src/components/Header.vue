        ...
        <header>
            <nav class="navbar navbar-expand-lg">
                <router-link class="nav-link" to="/" >
                  <img id="headerimg" src="../assets/logorent.png" alt="">
                </router-link>
                                ...
                                <template v-if="user.loggedIn">
                                    <template v-if="user.data.email == 'art-2000@hotmail.com'">
                                        ...
                                        <router-link class="nav-link" to="/products" >
                                            <a class="nav-link" id="alinkcars">Cars</a>
                                        </router-link>
                                         <router-link class="nav-link" to="/reservations" >
                                            <a class="nav-link" id="alinkreserve">Reserve</a>
                                        </router-link>
                                        <router-link class="nav-link" to="/myreservations" >
                                            <a class="nav-link" id="alinkmyr">My Reservations</a>
                                        </router-link> 
                                    </template> 
                                    <template v-else>
                                        <router-link class="nav-link" to="/reservations" >
                                            <a class="nav-link" id="alinkreser">Reserve</a>
                                        </router-link>
                                        <router-link class="nav-link" to="/myreservations" >
                                            <a class="nav-link" id="alinkmyreserv">My Reservations</a>
                                        </router-link>  
                                    </template>
                                </template>
                                <template v-else>
...
// map `this.user` to `this.$store.getters.user`
  ...
  methods: {
    ...
    _addDarkTheme() {
      ...
      document.getElementById("headerimg").src = 'http://localhost:8080/logorentwhite.png';
    ...
    _removeDarkTheme() {
      ...
      document.querySelector('footer').style = 'background-color:#2e3192';
      ...
      document.getElementById("headerimg").src = 'http://localhost:8080/logorent.png';
